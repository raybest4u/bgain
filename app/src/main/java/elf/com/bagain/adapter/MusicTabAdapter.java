...
public class MusicTabAdapter extends FragmentPagerAdapter {
	...
	public Fragment getItem(int position) {
		...
		switch (position) {
		case 0:
			return DonghuaFragment.newInstance(3);
		case 1:
			return DonghuaFragment.newInstance(31);
		case 2:
			return DonghuaFragment.newInstance(30);
		case 3:
			return DonghuaFragment.newInstance(59);
		case 4:
			return DonghuaFragment.newInstance(130);
		default:
			return DonghuaFragment.newInstance(3);
		}
