 ...
 */
public class Categorydapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public Categorydapter(Activity hostActivity) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        switch (viewType) {
            ...
            case TYPE_BLIBLI_ITEM:
                return new BiliDingHolder(layoutInflater.inflate(R.layout.blibli_ding_item_category, parent, false));
