...
package elf.com.bagain.utils.glide;
...
import elf.com.bagain.utils.ColorUtils;
import elf.com.bagain.utils.ViewUtils;
 ...
 *
 */
public class BlibliTarget extends GlideDrawableImageViewTarget implements Palette
        .PaletteAsyncListener {

    private boolean playGifs;

    public BlibliTarget(BadgedFourThreeImageView view, boolean playGifs) {
        super(view);
